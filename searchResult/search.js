var dataPhoto = [{
    ...
    name: "IS Clinical Cleasing Complex Exfoliant Cleasing (4fl.oz.)(6fl.oz.)",
    price: "$45",
    productPrice: 45,
    productQuantity: 1,
    brand:"IS Clinical"
    ...
    name: "EltsMD AM Therapy Facial Moisturizer(1.7 oz.)",
    price: "$39",
    productPrice: 39,
    productQuantity: 1,
    brand:"EltsMD"
...
var searchData = JSON.parse(localStorage.getItem("seachValue")) || "";


var searchObj = dataPhoto.filter(function(element){
    if(searchData.toUpperCase() == element.brand.toUpperCase() || searchData.toUpperCase() == element.name.toUpperCase()){
        return(element)
    }
});
